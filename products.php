...
<html>
    ...
    <body>
        <div>
            ...
            ?>
            <div class="container">
                <div class="jumbotron" id="manuelBackground">
                    <h1>Welcome!</h1>
                    <p>Get quality goods at their lowest price.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product-1.jpg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iPhone 1</h3>
                                    <p>Price: Ghc 36000.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product-5.jpg" alt="iPhone 7">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iPhone 7</h3>
                                    <p>Price: Ghc 40000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <script>document.write(new Date().getFullYear());</script> <a href="https://codingrev.netlify.com"> Manuel E-Commerce</a> Store. All Rights Reserved.</p>
                   <p>This website is developed by Emmanuel Owusu (UEB1103619)</p>
               </center>
               </div>
           </footer>
        </div>
